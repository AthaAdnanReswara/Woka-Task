...
{
    /**
     * Tampilkan halaman profil + modal edit
     */
    public function index()
    {
        ...
        return view('PM.profile.index', compact('user', 'profile'));
    }
    ...
    public function update(Request $request)
    {
        ...
        return redirect()->route('PM.profile.index')->with('success', 'Profil berhasil diperbarui!');
    }
}
