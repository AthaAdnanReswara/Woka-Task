...
<div class="container-fluid py-4">
    ...
    <div class="card border-0 shadow-sm rounded-3">
        ...
        <form action="{{ route('admin.collaborator.update', $collab->id) }}" method="POST" class="p-4">
            @csrf
            @method('PUT')
            ...
            <div class="mb-3">
                ...
                <select name="task_id" class="form-select" required>
                    ...
                    @foreach($tasks as $t)
                    <option value="{{ $t->id }}" {{ $collab->task_id == $t->id ? 'selected' : '' }}>
            ...
            <div class="mb-3">
                ...
                <select name="user_id" class="form-select" required>
                    ...
                    @foreach($users as $u)
                    <option value="{{ $u->id }}" {{ $collab->user_id == $u->id ? 'selected' : '' }}>
                        {{ $u->name }}
                    </option>
                    @endforeach
                </select>
            ...
            <div class="d-flex justify-content-end mt-3">
                <a href="{{ route('admin.collaborator.index') }}" class="btn btn-secondary me-2">
