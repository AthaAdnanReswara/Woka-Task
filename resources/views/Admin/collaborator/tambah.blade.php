@extends('layout.app')
@section('title', 'tambah collaborator')
@section('content')
<div class="container-fluid py-4">
    ...
    <div class="card border-0 shadow-sm rounded-3">
        ...
        <form action="{{ route('admin.collaborator.store') }}" method="POST">
            @csrf
            ...
            <div class="card-footer text-end">
                <a href="{{ route('admin.collaborator.index') }}" class="btn btn-danger shadow-sm">
