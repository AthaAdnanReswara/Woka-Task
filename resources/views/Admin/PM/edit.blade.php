...
<div class="container-fluid py-4">
    ...
    <div class="card border-0 shadow-sm rounded-3">
        <div class="card-header bg-primary text-white">
            <h5 class="mb-0">
                <i class="bi bi-pencil-square"></i> Edit Project Manager
            </h5>
        </div>

        <form action="{{ route('admin.PM.update', $PM->id) }}" method="POST" class="p-4" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            ...
            <div class="mb-3">
                ...
                <input type="text" name="name" value="{{ old('name', $PM->name) }}" class="form-control " placeholder="Masukkan nama lengkap...">
                @error('name')
            ...
            <div class="mb-3">
                ...
                <input type="email" name="email" value="{{ old('email', $PM->email) }}" class="form-control " placeholder="Masukkan email...">
                @error('email')
                <small class="text-danger">{{ $message }}</small>
                @enderror
            </div>
            ...
            <div class="mb-3">
                ...
                <div class="mt-3">
                    ...
                    <img src="{{ asset('storage/' . $PM->profile->foto) }}"alt="Foto Lama" width="120"
            ...
            <div class="d-flex justify-content-end mt-3">
                <a href="{{ route('admin.PM.index') }}" class="btn btn-secondary me-2">
